odoo.define_section('ch14_r04', ['ch14_r04', 'web.Model'], function (test, mock) {
    test('FieldMany2OneButtons', function(assert, ch14_r04, model)
    {
        ...
        widget = new ch14_r04.FieldMany2OneButtons(
            fake_field_manager,
            {
                attrs: {
                    modifiers: '{}',
